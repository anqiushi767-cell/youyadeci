...
const props = defineProps({
  wispDensity: { type: Number, default: 1 },
  mouseSmoothTime: { type: Number, default: 0.0 },
  mouseTiltStrength: { type: Number, default: 0.01 },
  horizontalBeamOffset: { type: Number, default: 0.1 },
  verticalBeamOffset: { type: Number, default: 0.0 },
  flowSpeed: { type: Number, default: 0.35 },
  verticalSizing: { type: Number, default: 2.0 },
  horizontalSizing: { type: Number, default: 0.5 },
  fogIntensity: { type: Number, default: 0.45 },
  fogScale: { type: Number, default: 0.3 },
  wispSpeed: { type: Number, default: 15.0 },
  wispIntensity: { type: Number, default: 5.0 },
  ...
  color: { type: String, default: '#A0FFBC' },
...
const baseDprRef = ref(1);
const currentDprRef = ref(1);
const fpsSamplesRef = ref([]);
const lastFpsCheckRef = ref(performance.now());
const emaDtRef = ref(16.7); // ms
const pausedRef = ref(false);
const inViewRef = ref(true);
...
<template>
  <div ref="mountRef" class="lf-root" :class="className" :style="style" />
</template>

<style scoped>
.lf-root { width: 100%; height: 100%; position: relative; overflow: hidden; }
</style>
