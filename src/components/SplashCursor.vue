<template>
  <div class="sc-wrap">
    <canvas ref="canvasRef" id="fluid" class="sc-canvas" />
  </div>
</template>
...
<style scoped>
.sc-wrap { position: fixed; top: 0; left: 0; z-index: 50; width: 100%; height: 100%; pointer-events: none; }
.sc-canvas { display: block; width: 100vw; height: 100vh; }
</style>
